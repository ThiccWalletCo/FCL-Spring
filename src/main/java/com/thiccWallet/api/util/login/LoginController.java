package com.thiccWallet.api.util.login;

import com.thiccWallet.api.util.common.exception.DuplicateLoginAttemptException;
import com.thiccWallet.api.util.common.exception.NoSuchUserException;
import com.thiccWallet.api.util.common.exception.NotLoggedInException;
import com.thiccWallet.api.util.login.dtos.request.LoginRequest;
import com.thiccWallet.api.data.user.User;
import com.thiccWallet.api.data.user.UserService;
